...
//   updte by model,user,data
  const dbUpdateItem = (model, keyValue, data ) =>{
  return model.findByIdAndUpdate(keyValue, {...data}, {new:true, ValidityState:true})
  }
...
const populateUpdateItem = (model, key, keyValue, data ) =>{
  ...
  module.exports = {dbFindPropertyById,dbCreateNewItem,dbDeletedItem,dbGetItems,dbUpdateItem, populateUpdateItem}